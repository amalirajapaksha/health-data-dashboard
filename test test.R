...
pop_data <- readRDS("population_pyramid_tidy.rds")
pop_data$Age <- as.numeric(pop_data$Age)

life_table_tidy <- readRDS("life_table_tidy.rds")
life_table_tidy$Age <- as.numeric(life_table_tidy$Age)

age_dis <- readRDS("age_distribution_tidy.rds")

current_pop_dis <- readRDS("current_population_distribution_tidy.rds")

pop_trend <- readRDS("population_trend_tidy.rds")

age_distribution_calculations <- readRDS("age_distribution_calculations.rds")
